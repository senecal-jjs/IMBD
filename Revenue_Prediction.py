...
def calculate(data):
    ...
    for instance in class1:
        labeled_data.append(([instance.budget, instance.fb_likes], 0))

    for instance in class2:
        labeled_data.append(([instance.budget, instance.fb_likes], 1))

    for instance in class3:
        labeled_data.append(([instance.budget, instance.fb_likes], 2))

    for instance in class4:
        labeled_data.append(([instance.budget, instance.fb_likes], 3))
    ...
    print("Test data score: %s" % model.score(Xt, Yt))
